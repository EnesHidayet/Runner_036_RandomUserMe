...
public class UserRepositoryImpl {
    ...
    public List<User> fromRandomUserMe(){
        ...
        try {
            ...
            Gson gson=new Gson();
            JsonElement jsonElement = JsonParser.parseString(sb.toString()); // 1. adým string to jsonElement
            JsonObject jsonObject= jsonElement.getAsJsonObject(); // 2. adým jsonElement i jsonObjecte dönüþtürüyoruz.
